...
public class ObjectFactory {
    ...
    private final static QName _GetStudents_QNAME = new QName("http://soapserver.mycompany.com/", "getStudents");
    private final static QName _HelloStudent_QNAME = new QName("http://soapserver.mycompany.com/", "helloStudent");
    private final static QName _GetStudentsResponse_QNAME = new QName("http://soapserver.mycompany.com/", "getStudentsResponse");
    private final static QName _HelloResponse_QNAME = new QName("http://soapserver.mycompany.com/", "helloResponse");
    private final static QName _Hello_QNAME = new QName("http://soapserver.mycompany.com/", "hello");
    private final static QName _HelloStudentResponse_QNAME = new QName("http://soapserver.mycompany.com/", "helloStudentResponse");
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapserver.mycompany.com/", name = "getStudents")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapserver.mycompany.com/", name = "helloStudent")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapserver.mycompany.com/", name = "getStudentsResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapserver.mycompany.com/", name = "helloResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapserver.mycompany.com/", name = "hello")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://soapserver.mycompany.com/", name = "helloStudentResponse")
